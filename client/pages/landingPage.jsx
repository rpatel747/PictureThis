    ...
    return (
        ...
        <div>
            ...
            <main>
                ...
                <h3 id="landing-blurb">Limitless is an open canvas to explore and share different interests. Upload pictures and videos, or start a blog or forumn. The options are limitless.</h3>
                </div>

                <div class="landing-pictures">
                    <div id={"landing-picture-1"}>
